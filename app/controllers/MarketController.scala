...
object MarketController extends Controller {
    ...
    def CurrentTrade = Action {
        val f0 = Future(HTTP("http://api.huobi.com/staticmarket/detail_btc_json.js").header("Accept" -> "application/json", "Content-Type" -> "application/json").get(Map.empty))
    		val f1 = Future(HTTP("http://api.huobi.com/staticmarket/detail_ltc_json.js").header("Accept" -> "application/json", "Content-Type" -> "application/json").get(Map.empty))
